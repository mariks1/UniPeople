...
public final class NotificationInboxSpecs {
    ...
    public static Specification<NotificationInbox> inboxForUser(
            UUID me,
        ...
        return (root, query, cb) -> {
            ...
            Join<NotificationInbox, NotificationEvent> e = root.join("event", JoinType.INNER);
    ...
    public static Specification<NotificationInbox> inboxByEmployee(
            UUID employeeId,
            Boolean unreadOnly,
            String source,
            String eventType,
