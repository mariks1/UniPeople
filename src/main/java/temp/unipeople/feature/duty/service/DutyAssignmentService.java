...
import temp.unipeople.feature.duty.repository.DepartmentDutyAssignmentRepository;
...
public class DutyAssignmentService {
    ...
    private final DepartmentDutyAssignmentRepository assignmentRepo;
    ...
    public DutyAssignmentDto assign(UUID departmentId, AssignDutyRequest req) {
        ...
        DepartmentDutyAssignment a = DepartmentDutyAssignment.builder()
                ...
                .duty(duty)
                .note(req.getNote())
                .assignedBy(req.getAssignedBy() != null ? em.getReference(Employee.class, req.getAssignedBy()) : null)
                .build();
