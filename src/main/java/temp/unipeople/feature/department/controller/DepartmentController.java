...
public class DepartmentController {
    ...
    // Для этого на уровне БД нужна таблица назначений обязанностей (M:N c payload), см. ниже комментарий.
    ...
    public ResponseEntity<Page<Object>> listDutyAssignments(@PathVariable UUID id, Pageable pageable) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("X-Total-Count", "0");
        return new ResponseEntity<>(Page.empty(pageable), headers, HttpStatus.NOT_IMPLEMENTED);
    }
