...
public class LeaveRequestController {
  ...
  public ResponseEntity<Object> reject(
      @PathVariable UUID id, @RequestBody Map<String, Object> body /* {reason} */) {
    return ResponseEntity.status(HttpStatus.NOT_IMPLEMENTED).build();
  }
  ...
  public ResponseEntity<Page<Object>> listByEmployee(
  ...
  public ResponseEntity<Page<Object>> pendingForDepartment(
